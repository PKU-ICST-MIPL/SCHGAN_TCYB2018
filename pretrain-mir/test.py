...
WORKDIR = '../mir/'
DIS_MODEL_BEST_FILE = './model/dis_best_nn' + str(OUTPUT_DIM) + '.model'
...
def test():	
	...
	sio.savemat('./result/DIS_mir_' + str(OUTPUT_DIM) + '.mat', {'B_I_db': I_db, 'B_T_db': T_db, 'B_I_te': I_te, 'B_T_te': T_te})
	sess.close()
